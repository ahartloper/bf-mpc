...
#include <SMAAspUserSubroutines.hdr>
        if (lop == 0) then
          open(unit=read_unit, file='interface_props.txt', status='old')
...
! ******************************************************************** !
     ...
     1                              interf_node_elem_arr_id, 
     2                              section_prop_arr_id
    ...
    !           ptr_iarr=SMAIntArrayCreate(interf_node_elem_arr_id,
    !  1                                   3*n_val,-1)
